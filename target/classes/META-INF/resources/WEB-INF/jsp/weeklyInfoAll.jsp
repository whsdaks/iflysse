...
<html>
	...
	<table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;" class="table2excel" id="LAY-EXPORT-TEST">
        ...
        <tr>
            ...
            <th colspan="11" class="noExl1">第${wNumber }周报表
            <input type="button" 
            onclick="table2Excel('第${wNumber }周报表')" 
            value="导出周报"></th>
        </tr>
		<tr>
            <th >学院名称</th>
            <th colspan="4">人工智能学院</th>                      
       
        </tr>
        <tr><th>周数</th><th>周报内容</th><th>填写时间</th><th colspan="2">填报教师</th></tr> 
       <c:forEach items="${weekly }" var="weekly">       		
		<tr>
		<%-- <td><input type="hidden" name="wNumber" value="${weekly.wNumber }"></td> --%>			
		<td>${wNumber }周</td>
