...
public class SendMail {
        ...
        public static String sendEmailAccount = "tomcat2020@foxmail.com";
        // 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
        public static String sendEmailPassword = "iimhjajjgcukdeai";
        ...
        public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
            ...
            // 设置发件人姓名和编码格式
            message.setFrom(new InternetAddress(sendMail, "博思教师辅助平台", "UTF-8"));
